...
class LoanApplicationRestructureEligibleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $releaseDate = Carbon::now()->subMonths(5)->startOfDay();
        $termMonths = 6;
        $principalAmount = 12000.00;
        $interestRate = 1.00; // monthly percent
        ...
        $loanApplication = LoanApplication::updateOrCreate(
            [
                ...
                'purpose' => 'Restructure Eligibility Test Loan',
            ],
            [
                ...
                'evaluation_notes' => 'Seeded normal loan for restructure eligibility testing.',
                'bici_notes' => 'Do not restructure automatically. This loan is for manual restructuring UI tests.',
                'submitted_at' => $releaseDate->copy()->subDays(7),
        ...
        $this->command?->info("Restructure-eligible test loan application seeded. Loan Application ID: {$loanApplication->loan_application_id}");
        $this->command?->info("Restructure-eligible test loan account seeded. Loan Account ID: {$loanAccount->loan_account_id}");
    }
}

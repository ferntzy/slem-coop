                                ...
                                <div className="relative aspect-square">
                                    {!imageError ? (
                                        <img
                                            ...
                                            alt="SLEM COOP Mascot - Sad"
                                            className="w-full h-full object-cover"
                                            onError={() => setImageError(true)}
                                        />
                                    ) : (
                                        <div className="text-center space-y-3 w-full h-64 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-lg">
                                            <div>
                                                <div className="flex justify-center">
                                                    <div className="bg-gray-300 dark:bg-gray-600 rounded-2xl p-6">
                        ...
                        >
                            ...
                            <div className="space-y-3 lg:space-y-4">
                                ...
                                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed max-w-sm lg:max-w-none">
                                    Our team has been notified. We're working to fix the issue. Please try again in a moment.
                                </p>
                            </div>

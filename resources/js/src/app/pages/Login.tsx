                ...
                <div className="grid min-h-screen lg:grid-cols-2">
                    ...
                    <div className="relative z-10 max-w-xl">
                        ...
                        <h1 className="mt-8 text-4xl sm:text-5xl font-black tracking-tight text-white">
                            Access your coop membership dashboard.
                        </h1>
                        <p className="mt-5 max-w-xl text-base leading-8 text-green-100/65">
                            Sign in to manage loans, savings, notifications, and member services in one secure place.
                        </p>
                        ...
                        <div className="mt-12 space-y-4 text-sm text-green-200/90">
                            <p className="flex items-center gap-3">
                                ...
                                Fast member access and personalized loan offers.
                            </p>
                            <p className="flex items-center gap-3">
                                <span className="inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-white/15 text-white">✓</span>
                                Secure cooperative banking built for your community.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="w-full max-w-lg mx-auto flex flex-col">
                        ...
                        <div className="mb-12 text-center">
                            ...
                            />
                            <h2 className="text-3xl font-black text-gray-900 dark:text-white">Sign in to your account</h2>
                        ...
                        <div className="rounded-[2rem] border border-green-100/50 dark:border-white/10 bg-white dark:bg-[#111b17] p-8 shadow-lg">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-3xl border border-green-200 bg-white px-5 py-3 text-gray-900 outline-none transition focus:border-green-500 disabled:cursor-not-allowed disabled:opacity-60 dark:border-white/10 dark:bg-white/5 dark:text-white"
                                        disabled={isLoading}
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            required
                                            placeholder="••••••••"
                                            className="w-full rounded-3xl border border-green-200 bg-white px-5 py-3 pr-12 text-gray-900 outline-none transition focus:border-green-500 disabled:cursor-not-allowed disabled:opacity-60 dark:border-white/10 dark:bg-white/5 dark:text-white"
                                            disabled={isLoading}
                                        />
                                        <button
                                            type="button"
                                ...
                                <div className="pt-5 mt-6 border-t border-green-100 dark:border-white/10">
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="flex w-full items-center justify-center gap-2 rounded-3xl bg-green-700 px-5 py-3 text-sm font-bold uppercase tracking-[0.12em] text-white shadow-xl transition hover:bg-green-800 disabled:cursor-wait"
                                    >
                            ...
                            <div className="mt-8 border-t border-green-100 pt-6 text-center text-sm text-gray-700 dark:text-gray-400">
                                <p>New here? <a href="/membership/info" className="font-semibold text-green-700 dark:text-green-300 hover:underline">Create an account</a></p>
                            </div>
                        </div>
